...
def handle_folder_configs():
    ...
    with st.sidebar:
        st.write("Mensagem: No momento funcionara apenas com o ID '1HKers4WGkpyTvNDU4a_FB3UrEgxDB29E' com materias do eternal")


        folder_id = st.text_input("Insirta o ID da pasta do Google Drive ", "1HKers4WGkpyTvNDU4a_FB3UrEgxDB29E")
        config_name = st.text_input("Insira seu nome de usuario")
        if st.button(
            "Executar",
        ):
...
st.title("Converse com seus arquivos do Google Drive")
